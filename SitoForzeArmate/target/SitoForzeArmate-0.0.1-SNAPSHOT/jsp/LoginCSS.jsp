...
<div style="min-height: 100vh; display: flex; align-items: center; justify-content: center;">
    <div style="max-width: 24rem; width: 100%; padding: 1.5rem; background-color: #fff; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); border-radius: 0.375rem;">
        ...
        <div style="margin-top: 1.5rem;">
            <p>
                Se non hai ancora un account: <a href="Dispatcher?controllerAction=Login.viewRegistrazione" style="color: #3b82f6; font-weight: 600;">Registrati</a>
            </p>
            <p>
                <%// Invece che Dispatche?.... mettere solo link, es /homepage per andare alla homepage %>
                Se invece sei un <a href="Dispatcher?controllerAction=Login.viewAmministratore" style="color: #3b82f6; font-weight: 600;">Amministratore</a>
            </p>

            <br>
            <a href="Dispatcher?controllerAction=PaginaIniziale.view" style="width: 100%; padding: 0.5rem 1rem; background-color: #3b82f6; color: #fff; font-weight: 600; border-radius: 0.375rem; outline: none; cursor: pointer; transition: background-color 0.2s ease-in-out;">Indietro</a>
