...
public class PrenotaAlloggioIntegrationTest {
    @Autowired
    ...
    @Test 
    public void integration_viewAlloggi() throws Exception {
        ...
        this.mockMvc.perform(post("/viewPrenotaAlloggi")
                .param("locazioneBase", locazione)
                .cookie(new Cookie("loggedUser", cookieUser)))
            .andDo(print())
            .andExpect(status().isOk())
            .andExpect(view().name("ListaBasi/PrenotaAlloggioCSS"))
            .andExpect(model().attribute("loggedOn", true))
            .andExpect(model().attributeExists("locazioneAlloggio"));
    }
    ...
    public void integration_confermaIscrizione() throws Exception {
        ...
        this.mockMvc.perform(post("/confermaIscrizione")
                .param("locazioneAlloggio", locazione)
                .param("NumeroPersone", nPersone)
                .param("NumeroNotti", nNotti)
                .param("DataArrivo", data)
                .cookie(new Cookie("loggedUser", cookieUser)))
            .andDo(print())
            .andExpect(status().isOk())
            ...
            .andExpect(model().attributeExists("PostoLetto"));
    }
}